package lab4p1_víctorromero;

import java.util.Scanner;

public class Lab4P1_VíctorRomero {
    ...
    public static void binary(String num1, String num2) {
        ...
        if (num1.length() == num2.length()) {
            ...
            for (int v = num1.length() - 1; v >= 0; v--) {
                if ((num1.charAt(v) == '0' && restante == '0')
                        || ((num1.charAt(v) == '1' && restante == '0'))) {
                    if (num2.charAt(v) == '0') {
                        restante = '0';
                        result = "0" + result;
                    } else {
                ...
                } else if (num1.charAt(v) == '1' && restante == '0') {
                    restante = '0';
                    if (num2.charAt(v) == '0') {
                        result = "1" + result;
                    } else {
                ...
                } else if(num1.charAt(v)=='0' && restante == '1'){
                        restante ='1';
                        if (num2.charAt(v)=='0'){
                        result = "1" + result;   
                        }else {
